...
class ValueIntegrationTest(unittest.TestCase):
    ...
    def test_fhir_resource_value(self):
        ...
        fhir_resource_value = value.JSONValue(raw=fhir_resource)

        # __bool__ should be True
        self.assertTrue(fhir_resource_value)
        self.assertTrue(IJSONModel.providedBy(fhir_resource_value.foreground_origin()))
        ...
        empty_resource = value.JSONValue()
